...
<fieldset id="finance-checkout" class="finance-calculator" data-<?=$environment;?>-amount="<?php print $amount; ?>" data-<?=$environment;?>-plans="<?php print $plans; ?>">
<h1>
        <?php print (isset($this->settings['description'])) ? $this->settings['description']:""; ?>
    </h1>
<div id="financeWidget" data-<?=$environment;?>-widget data-<?=$environment;?>-plans="<?php print $plans; ?>" data-<?=$environment;?>-amount="<?php print $amount; ?>" ></div>
